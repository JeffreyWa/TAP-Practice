...
##"/v2/events?created_ats[gt]=2022-08-12T16:41:00Z&space_guids=4aa00c57-4208-4ee8-b9d3-086ceaceb43e&order-direction=desc&results-per-page=5&page=2" | jq -r '.resources[].entity | {timestamp,organization_guid,space_guid,actee_type,actee_name,actor_name,type,metadata} | to_entries | map(.value|tostring) |@csv'
